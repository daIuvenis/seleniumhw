...
public class tempMail {
    ...
    public void setTextInTextFieldSubject(){
        textFieldTheme.sendKeys("Test");
    }
    ...
    private WebElement textReTest;

    public void clickToMessageText(){
        textReTest.click();
    }
    public String getTextReTest(){
        return textReTest.getAttribute("textContent");
    }
    ...
    public void settingsOpenBefore(){
