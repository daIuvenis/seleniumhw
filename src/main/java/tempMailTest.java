...
public class tempMailTest {
    ...
    String nameDomain = name + domain;
        ...
        String deleteReTest = driver.findElement(By.cssSelector("#container-body > div > div.inbox > div.mail > div > div.subj.col-12.col-md-7.px-md-3 > span")).getAttribute("textContent");
        Assert.assertEquals(themeSender, deleteReTest);
